        ...
        <>
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <TextField label='Enter Category Name' placeholder='Enter Category Name' type='text' fullWidth required
                        onChange={e => setAddNewCategory({ ...addNewCategory, CategoryName: e.target.value })} value={addNewCategory.CategoryName} />
