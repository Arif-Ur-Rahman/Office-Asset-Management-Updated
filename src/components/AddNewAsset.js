...
function AddNewAsset({ show, onHide }) {
    ...
    const SubmitHandler = () => {
        ...
        if (addNewAsset.CategoryId !== "" && addNewAsset.AssetName !== "" && addNewAsset.IsIdentifiable !== "" && 
                (addNewAsset.IsIdentifiable >= 0 && addNewAsset.IsIdentifiable < 3)) {
        ...
        <>
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <TextField label='Enter Asset Details' placeholder='Enter Asset Details' type='text' fullWidth 
